...
public class FollowingAdapter extends ArrayAdapter<FollowInfo> {

    public FollowingAdapter(Context context , int i, ArrayList<FollowInfo> users) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView follower_name = (TextView) convertView.findViewById(R.id.following_username);
        ImageView follower_Image= (ImageView) convertView.findViewById(R.id.following_Image);
        ...
        if (n==1){
            ...
            follower_Image.setImageResource(R.drawable.d1);
        }
        else if(n==12){
            follower_Image.setImageResource(R.drawable.r12);
        }
        else if(n==13){
            follower_Image.setImageResource(R.drawable.d3);
        }
        else if(n==14){
            follower_Image.setImageResource(R.drawable.d4);
        }
        else if(n==15){
            follower_Image.setImageResource(R.drawable.d5);
        }
        else if(n==16){
